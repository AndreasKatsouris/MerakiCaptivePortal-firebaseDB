...
Last updated: 2026-05-15 (post PR #65 merge — reflect cycle. Phase 6 PR 3 shipped: Run execution UI honouring all 10 inputTypes. Pre-merge session resolved 6 outstanding automated-review findings on the inflight PR (1 🔴 must-fix: onSave 422 wiring + store flag + card watcher; 1 🟡: dead getRun mock; 4 🔵 NITs) — operator caught that the mid-PR reflect had not addressed any review items beyond the operator-preview server-shape fixes. Also rebased PR #65 onto current master, resolving 5 dual-reflect doc conflicts.)
